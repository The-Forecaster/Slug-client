...
abstract class Setting<T : Any>(name: String, description: String, default: T, val isParentSetting: Boolean) : ModularSettingContainer(name, description), Comparable<Setting<*>> {
    var value: T = default
