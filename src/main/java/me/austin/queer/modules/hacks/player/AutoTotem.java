...
@Hack.Register(name = "Auto Totem", description = "Places a totem in your offhand", category = Category.PLAYER)
public class AutoTotem extends Hack {
    public final ModeSetting item = register(new ModeSetting("Item", "Which item should it put in your offhand", TargetItem.TOTEM, TargetItem.values()));
